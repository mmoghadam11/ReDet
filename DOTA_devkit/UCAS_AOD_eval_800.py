#%%writefile /content/ReDet/DOTA_devkit/UCAS_AOD_eval_800.py
...
def main():
    ...
    annopath = r'/content/ReDet/data/UCAS-AOD/Test/labelTxt/{:s}.txt'
    imagesetfile = r'/content/ReDet/data/UCAS-AOD/ImageSets/test.txt'
    ...
    for classname in classnames:
        ...
        plt.plot(rec, prec)
        plt.show()
        plt.savefig('/content/ReDet/work_dirs/faster_rcnn_obb_r50_fpn_3x_UCAS_AOD/pr_curve/{}.png'.format(classname))
    map = map/len(classnames)
    print('map:', map)
    classaps = 100*np.array(classaps)
    print('classaps: ', classaps)
