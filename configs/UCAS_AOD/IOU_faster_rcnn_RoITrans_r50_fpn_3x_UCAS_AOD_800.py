...
# %%writefile /content/ReDet/configs/UCAS_AOD/faster_rcnn_RoITrans_r50_fpn_3x_UCAS_AOD_800.py
...
log_level = 'INFO'
work_dir = '/content/ReDet/work_dirs/IOU_faster_rcnn_RoITrans_r50_fpn_3x_UCAS_AOD_800'
load_from = None
resume_from = None
workflow = [('train', 1)]
